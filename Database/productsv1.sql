...
Values  ('Burstall Artificial Plant','Living','Accents', 55.99, 1.38), 
        ...
        ('Cosmic Throw', 'Decor', 'Throws', 79.99, 1.75);
          ...
          select Category, count(Category) from Productsv1 group by Category;
        
		select ID, category from Productsv1 where name = 'Bassano Table Lamp';
